...
const EXPERTISE_FR = [
  {
    label: "Priorite",
    title: "Accidents",
    highlight: "de la route",
    description:
      "Victimes de collisions, pietons renverses, passagers blesses. Loi Badinter, FGAO, indemnisation maximale.",
  },
  {
    label: "Specialiste CNB",
    title: "Traumatisme",
    highlight: "cranien",
    description:
      "Sequelles cognitives invisibles, expertises medicales contradictoires, indemnisation des proches et aidants.",
  },
  {
    label: "Defense des victimes",
    title: "Dommage",
    highlight: "corporel",
    description:
      "Prejudice physique, moral et economique. Reparation integrale pour chaque victime.",
  },
  {
    label: "Accompagnement complet",
    title: "Victimes",
    highlight: "d'infractions",
    description:
      "Agressions, homicides, viols, soumission chimique. Constitution de partie civile, FGTI.",
  },
] as const;
...
const EXPERTISE_EN = [
  {
    ...
    highlight: "accidents",
    description:
      "Collision victims, pedestrians, injured passengers. Badinter Law, FGAO, maximum compensation.",
  },
  {
    label: "CNB Specialist",
    title: "Traumatic brain",
    highlight: "injury",
    description:
      "Invisible cognitive after-effects, conflicting medical expertise, compensation for families and caregivers.",
  },
  {
    label: "Victim defense",
    title: "Personal",
    highlight: "injury",
    description:
      "Physical, moral and economic damages. Full compensation for every victim.",
  },
  {
    label: "Full support",
    title: "Victims",
    highlight: "of crime",
    description:
      "Assaults, homicides, rapes, chemical submission. Civil party claims, FGTI.",
  },
] as const;

export function ExpertiseSection({ locale }: ExpertiseSectionProps) {
  const items = locale === "fr" ? EXPERTISE_FR : EXPERTISE_EN;
  const ctaLabel =
    locale === "fr" ? "Voir toutes nos expertises" : "See all our expertise";
  const rootHref = locale === "fr" ? "/" : "/en";

  return (
    <section id="expertise" className="results v1 dark-bg anm">
      ...
      <div className="results-content">
        ...
        <div>
          <Link href={`${rootHref}#Contact`} className="btn">
            {ctaLabel}
          </Link>
        </div>
      </div>
